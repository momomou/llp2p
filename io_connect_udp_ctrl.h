#ifndef __IO_CONNECT_UDP_CTRL_H__
#define __IO_CONNECT_UDP_CTRL_H__
...
class io_connect_udp_ctrl:public basic_class{
public:
	io_connect_udp_ctrl(network_udp *net_udp_ptr,logger *log_ptr,configuration *prep_ptr,peer_mgr * peer_mgr_ptr,peer *peer_ptr,pk_mgr * pk_mgr_ptr, peer_communication *peer_communication_ptr, logger_client * logger_client_ptr);
	~io_connect_udp_ctrl();
