...
parseurl::parseurl(logger * log_ptr)
{
	_log_ptr = log_ptr;
}
...
char * parseurl::str2lower(char *str, int len)
{
...
int parseurl::hex2bin(char *str, char **hex)
{
	if(!str || !hex)
		return 0;
 ...
 */
char * parseurl::ParsePlaypath(const char *playpath) {
